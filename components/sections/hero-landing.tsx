    ...
    <section className="space-y-6 py-12 sm:py-20 lg:py-20">
      <div className="container flex max-w-5xl flex-col items-center gap-5 text-center">
        ...
        Bringing People Together,{" "}
          <span className="text-gradient_orange font-extrabold">
        ...
        >
          Our mission is to break down social barriers, bringing strangers 
          together to share stories and build meaningful relationships.
        </p>
